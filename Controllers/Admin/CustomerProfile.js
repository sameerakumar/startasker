...
const db2Queries =  require('../Review/ReviewDBQueries');
const statusCodes = require('../Core/StatusCodes');
const paramValidations = require('./AdminParamvalidations');
const paramValidator = require('../Review/ReviewParamValidations');
const controller = require('../Review/FetchReview');
...
var FetchAllusers = {
    ...
    fetchdata: (params,callback) => {
        ...
        let getCustomerWithId = dbQueries.FetchQuery(params.userID);
        getCustomerWithId.then((isFound) => {
            if(isFound) {
                let aggregateQuery = dbQueries.getAggreateQuery(params.userID);
                aggregateQuery.then((data) => {
                    if (data) {
                        var providersTaskCompletedPercentage;
                        var posterTaskCompletedPercentage;
                        var getProviderBookingQuery = db2Queries.getProviderCompletedTaskQuery(params.userID);
                        ...
                        var getPosterBookingsQuery = db2Queries.getPosterCompletedTaskQuery(params.userID);
                        ...
                        let fetchReviewsQuery = db2Queries.getReviewsByUserID(params);
                        fetchReviewsQuery.then((found) => {
                            if (found) {
                                return getAsAProviderRatings(found, providersTaskCompletedPercentage, posterTaskCompletedPercentage,data, callback);
                ...
                function getAsAProviderRatings(found,params,params1,data,callback) {
                    var rating5 = [];
                    var rating4 = [];
                    var rating3 = [];
                    var rating2 = [];
                ...
                function getAsAPosterRatings(found,asAProvider,params1,callback) {
                    ...
                    return callback({
                        ...
                        data: {
                            ...
                            userInfo: data,asAProvider, asAPoster
