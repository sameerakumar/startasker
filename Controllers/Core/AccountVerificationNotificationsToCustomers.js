...
module.exports.admintransactionalNotificationscustomer = function admintransactionalNotificationscustomer(userID,firstName,data,reason,verified) {
    ...
    getSettingsQuery.then((settings) => {
        ...
        if (settings.notifications.transactional.Email == true) {
            console.log("sent to customer....")
                if(verified){
                    Mailer.accountVerificationNotification("AccountVerification - Verified", userID,firstName);
                }else{
                    Mailer.accountVerificationNotificationWithReason("AccountVerification - Rejected", userID,firstName,reason);
                }
        }
